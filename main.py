...
class MyFrame(wx.Frame):
    ...
    def __do_layout(self):
        ...
        sizer_2.Add(self.button_1, 0, wx.RIGHT, 0)
        sizer_2.Add(self.button_2, 0, wx.RIGHT, 0)
        sizer_2.Add(self.button_3, 0, wx.RIGHT, 0)
        sizer_2.Add(self.button_4, 0, wx.RIGHT, 0)
        sizer_2.Add(self.button_5, 0, wx.RIGHT, 0)
        sizer_2.Add(self.button_6, 0, wx.RIGHT, 0)
        sizer_2.Add(self.button_7, 0, wx.RIGHT, 0)
        #sizer_1.Add(sizer_2, 1, wx.EXPAND, 0)
        sizer_1.Add(sizer_2, 0, wx.RIGHT, 0)
